...
'sub_category_required_when_parent_has_children' => 'هذا التصنيف يحتوي على تصنيفات فرعية، يرجى اختيار أحدها أولاً.',
'custom' => [
    'name_ar' => [
    ...
    'name_en' => [
        ...
        'unique'   => 'الاسم موجود مسبقاً.',
            ...
            'email' => [
            'unique' => 'البريد الإلكتروني مُستخدم بالفعل.',
        ],
        'roles.*' => [
            'exists' => 'أحد الأدوار المحددة غير موجود.',
        ],
],
    ...
    'attributes' => [
        ...
        'sub_category_not_belongs_to_category' => 'التصنيف الفرعي المحدد لا ينتمي إلى التصنيف الرئيسي المختار.',
    'dynamic_field_not_belong' => 'الحقل الديناميكي المحدد لا ينتمي إلى التصنيف أو التصنيف الفرعي.',
];
