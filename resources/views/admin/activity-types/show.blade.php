...
<div class="show-activity-wrapper">
    ...
    <div class="page-header-modern">
        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    <h1>{{ $activityType->getTranslation('name', app()->getLocale()) }}</h1>
                    <p>{{ __('admin.activity_type_details') }}</p>
                </div>
            </div>
        ...
        <div class="action-buttons">
            <a href="{{ route('admin.activity-types.edit', $activityType) }}" class="btn-action btn-action-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('admin.activity-types.create') }}" class="btn-action btn-action-primary">
            ...
            <button type="button" class="btn-action btn-action-danger" id="deleteBtn"
                    data-type-name="{{ $activityType->getTranslation('name', app()->getLocale()) }}"
                    data-delete-url="{{ route('admin.activity-types.destroy', $activityType) }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="stats-grid">
            <div class="stat-card" style="animation-delay: 0.1s">
                ...
                <div class="stat-content">
                    <div class="stat-label">{{ __('admin.total_business_accounts') }}</div>
                    <div class="stat-value">{{ $activityType->businessAccounts->count() }}</div>
                </div>
            </div>
            <div class="stat-card" style="animation-delay: 0.15s">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value">{{ $activityType->created_at->format('Y-m-d') }}</div>
                </div>
            </div>
            <div class="stat-card" style="animation-delay: 0.2s">
                ...
                <div class="stat-content">
                    ...
                    <div class="stat-value">{{ $activityType->updated_at->diffForHumans() }}</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div>
            <div class="section-card">
                <div class="section-header">
                    ...
                    <span class="section-count">{{ $activityType->businessAccounts->count() }}</span>
                </div>

                @if($activityType->businessAccounts->isEmpty())
                ...
                @else
                    <div class="table-responsive">
                        <table class="modern-table">
                            ...
                            <tbody id="bizBody">
                                @foreach($activityType->businessAccounts as $biz)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        @if($biz->user)
                                            <div class="d-flex align-items-center gap-1">
                                                <div class="user-avatar">{{ strtoupper(substr($biz->user->first_name, 0, 1)) }}</div>
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li>
                        ...
                        <strong>{{ __('admin.activity_type_name_ar') }}:</strong> {{ $activityType->getTranslation('name', 'ar') }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                        ...
                        <strong>{{ __('admin.activity_type_name_en') }}:</strong> {{ $activityType->getTranslation('name', 'en') }}
                    </li>
