...
@section('styles')
    ...
    <style>
        ...
        .validation-hint[style*="color: #ef4444;"] {
            color: #ef4444;
        }
...
<div class="edit-activity-wrapper">
    {{-- Back link --}}
    <a href="{{ route('admin.activity-types.index') }}" class="back-link">
        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    <h1>{{ __('admin.edit_activity_type') }}</h1>
                    <p>{{ $activityType->getTranslation('name', app()->getLocale()) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modern-grid">
        ...
        <div class="form-card">
            <div class="form-card-header">
                ...
                <h3>{{ __('admin.activity_type_details') }}</h3>
            </div>
            <div class="form-card-body">
                <form action="{{ route('admin.activity-types.update', $activityType) }}" method="POST" id="editActivityForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-group-modern">
                        <label class="input-label" for="name_ar">
                            ...
                            {{ __('admin.activity_type_name_ar') }}
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   data-original="{{ $activityType->getTranslation('name', 'ar') }}"
                    ...
                    <div class="input-group-modern">
                        <label class="input-label" for="name_en">
                            ...
                            {{ __('admin.activity_type_name_en') }}
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text"
                                   ...
                                   data-original="{{ $activityType->getTranslation('name', 'en') }}"
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.activity-types.index') }}" class="btn-secondary-modern">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="sidebar-modern">
            ...
            <div class="live-preview-card">
                ...
                <div class="preview-type-icon" id="previewIcon">
                    <span id="previewIconLetter">{{ strtoupper(substr($activityType->getTranslation('name', 'en'), 0, 1)) ?: '🏢' }}</span>
                </div>
                <div class="preview-item">
                    ...
                    <div class="preview-item-content">
                        <div class="preview-item-label">{{ __('admin.activity_type_name_ar') }}</div>
                        <div class="preview-item-value" id="previewAr">{{ $activityType->getTranslation('name', 'ar') }}</div>
                    </div>
                </div>
                <div class="preview-item">
                    <div class="preview-item-icon">
                    ...
                    <div class="preview-item-content">
                        <div class="preview-item-label">{{ __('admin.activity_type_name_en') }}</div>
                        <div class="preview-item-value" id="previewEn">{{ $activityType->getTranslation('name', 'en') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                <div class="info-card-title">
                    ...
                    <span>{{ __('admin.activity_type_info') ?? 'معلومات النشاط' }}</span>
                </div>
                <ul class="info-list">
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <strong>{{ __('admin.total_business_accounts') }}:</strong> {{ $activityType->business_accounts_count ?? $activityType->businessAccounts()->count() }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <strong>{{ __('admin.created_at') }}:</strong> {{ $activityType->created_at->format('Y-m-d') }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <circle cx="12" cy="12" r="10"/>
                        ...
                        <strong>{{ __('admin.updated_at') }}:</strong> {{ $activityType->updated_at->diffForHumans() }}
                    </li>
                </ul>
                <div style="margin-top: 1.5rem;">
                    <a href="{{ route('admin.activity-types.show', $activityType) }}" class="quick-back">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
