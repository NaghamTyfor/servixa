        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    <h1>{{ __('admin.add_activity_type') }}</h1>
                    <p>{{ __('admin.activity_type_creation_tip') ?? 'أضف نوع نشاط جديد باللغتين العربية والإنجليزية' }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modern-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('admin.activity-types.store') }}" method="POST" id="createActivityForm">
                    @csrf
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li>
                        ...
                        {{ __('admin.tip_activity_ar') ?? 'أدخل الاسم بالعربية بشكل صحيح' }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"/>
                        </svg>
                        {{ __('admin.tip_activity_en') ?? 'الاسم الإنجليزي يبدأ بحرف كبير' }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"/>
                        </svg>
                        {{ __('admin.tip_activity_unique') ?? 'تأكد من عدم تكرار النشاط' }}
                    </li>
                </ul>
                <div style="margin-top: 1.5rem;">
                    <a href="{{ route('admin.activity-types.index') }}" class="quick-back">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <line x1="19" y1="12" x2="5" y2="12"/>
                            <polyline points="12 19 5 12 12 5"/>
                        </svg>
