...
@section('styles')
    ...
    <style>
        ...
        body.dark .form-control-modern:focus { background:#1a1830; }

        .sort-wrapper { position:relative; }
        .sort-wrapper input { padding-left:3rem; }
        ...
        .validation-hint svg { width:16px!important;height:16px!important; }
        ...
        body.dark .preview-header { border-bottom-color:rgba(124,58,237,0.15); }
        ...
        body.dark .preview-item { border-bottom-color:rgba(124,58,237,0.15); }
        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    ...
                    <p>{{ __('admin.add_new_category_desc') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modern-grid">
        <div class="form-card">
            <div class="form-card-header">
                ...
                <h3>{{ __('admin.category_details') }}</h3>
            </div>
            <div class="form-card-body">
                <form action="{{ route('admin.categories.store') }}" method="POST" id="createForm">
                    @csrf
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name_ar" id="name_ar" class="form-control-modern @error('name_ar') is-invalid @enderror"
                                   value="{{ old('name_ar') }}" placeholder="{{ __('admin.placeholder_ar') }}" required dir="rtl" autocomplete="off">
                        </div>
                        @error('name_ar')
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-wrapper">
                            <span class="flag-icon">🇬🇧</span>
                            <input type="text" name="name_en" id="name_en" class="form-control-modern @error('name_en') is-invalid @enderror"
                                   value="{{ old('name_en') }}" placeholder="{{ __('admin.placeholder_en') }}" required dir="ltr" autocomplete="off">
                        </div>
                        @error('name_en')
                            <div class="validation-hint" style="color:#ef4444;">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.categories.index') }}" class="btn-secondary-modern">
        ...
        <div class="sidebar-modern">
            <div class="live-preview-card">
                ...
                <div class="preview-type-icon"><span id="previewIconLetter">📁</span></div>
                <div class="preview-item">
                    <div class="preview-item-icon"><span style="font-size:1.2rem;">🇸🇦</span></div>
                    <div class="preview-item-content">
                        <div class="preview-item-label">{{ __('admin.name_ar') }}</div>
                        <div class="preview-item-value" id="previewAr">—</div>
                    </div>
                </div>
                <div class="preview-item">
                    <div class="preview-item-icon"><span style="font-size:1.2rem;">🇬🇧</span></div>
                    <div class="preview-item-content">
                        <div class="preview-item-label">{{ __('admin.name_en') }}</div>
                        <div class="preview-item-value" id="previewEn">—</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_category_bilingual') }}</li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_sub_categories') }}</li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_dynamic_fields') }}</li>
                </ul>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Swal.mixin({ toast:true, position:'top-end', showConfirmButton:false, timer:6000, timerProgressBar:true,
        didOpen: t => { t.addEventListener('mouseenter', Swal.stopTimer); t.addEventListener('mouseleave', Swal.resumeTimer); }
    }).fire({ icon:'error', title:'{{ __('admin.validation_error') }}', html:msgs });
});
@endif
</script>
@endsection
