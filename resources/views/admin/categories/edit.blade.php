    ...
    <div class="modern-grid">
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" id="editForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name_ar" id="name_ar"
                                   ...
                                   data-original="{{ $category->getTranslation('name', 'ar') }}"
                    ...
                    <div class="input-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="name_en" id="name_en"
                                   ...
                                   data-original="{{ $category->getTranslation('name', 'en') }}"
        ...
        <div class="sidebar-modern">
            <div class="live-preview-card">
                ...
                <div class="preview-type-icon"><span id="previewIconLetter">{{ strtoupper(substr($category->getTranslation('name','en'),0,1)) ?: '📁' }}</span></div>
                <div class="preview-item">
                    ...
                    <div class="preview-item-content">
                        ...
                        <div class="preview-item-value" id="previewAr">{{ $category->getTranslation('name','ar') }}</div>
                    </div>
                </div>
                <div class="preview-item">
                    <div class="preview-item-icon"><span style="font-size:1.2rem;">🇬🇧</span></div>
                    <div class="preview-item-content">
                        ...
                        <div class="preview-item-value" id="previewEn">{{ $category->getTranslation('name','en') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                        <strong>{{ __('admin.sub_categories') }}:</strong> {{ $category->subCategories()->count() }}</li>
                    ...
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        <strong>{{ __('admin.updated_at') }}:</strong> {{ $category->updated_at->diffForHumans() }}</li>
                </ul>
                <div style="margin-top:1.5rem;">
                    <a href="{{ route('admin.categories.show', $category) }}" class="quick-back">
