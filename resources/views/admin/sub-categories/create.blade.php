        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    <h1>{{ __('admin.add_sub_category') }}</h1>
                    <p>{{ __('admin.for_category') }}: {{ $category->getTranslation('name', app()->getLocale()) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modern-grid">
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('admin.categories.sub-categories.store', $category) }}" method="POST" id="createForm">
                    @csrf
        ...
        <div class="sidebar-modern">
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_sub_category_bilingual') }}</li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_sort_order') }}</li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>{{ __('admin.tip_dynamic_fields_sub') }}</li>
                </ul>
            </div>
        </div>
    </div>
