...
@section('styles')
    ...
    <style>
        ...
        .form-card {
            ...
            height: fit-content; /* تأخذ ارتفاع المحتوى فقط */
            min-height: 0;
        }
        ...
        .input-group-modern:last-of-type {
            margin-bottom: 0; /* إزالة الهامش السفلي من آخر حقل */
        }
        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    ...
                    <p>{{ __('admin.city_creation_tip') ?? 'أضف مدينة جديدة باللغتين العربية والإنجليزية' }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modern-grid">
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                <form action="{{ route('admin.cities.store') }}" method="POST" id="createCityForm">
                    @csrf

                    {{-- حقل الاسم بالعربية --}}
                    <div class="input-group-modern">
                        <label class="input-label" for="cityNameAr">
                    ...
                    <div class="input-group-modern">
                        <label class="input-label" for="cityNameEn">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                                <circle cx="12" cy="10" r="3"/>
                            </svg>
        ...
        <div class="sidebar-modern">
            ...
            <div class="live-preview-card">
                ...
                <div class="preview-city-icon" id="previewIcon">
                    <span id="previewIconLetter">🏙️</span>
                </div>
            ...
            <div class="info-card">
                ...
                <ul class="info-list">
                    <li>
                        ...
                        {{ __('admin.tip_city_ar') ?? 'أدخل الاسم بالعربية بشكل صحيح' }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"/>
                        </svg>
                        {{ __('admin.tip_city_en') ?? 'الاسم الإنجليزي يبدأ بحرف كبير' }}
                    </li>
                    <li>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="20 6 9 17 4 12"/>
                        </svg>
                        {{ __('admin.tip_city_unique') ?? 'تأكد من عدم تكرار المدينة' }}
                    </li>
                </ul>
                <div style="margin-top: 1.5rem;">
                    <a href="{{ route('admin.cities.index') }}" class="quick-back">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <line x1="19" y1="12" x2="5" y2="12"/>
                            <polyline points="12 19 5 12 12 5"/>
                        </svg>
...
<script>
    // عناصر المعاينة
    const arInput = document.getElementById('cityNameAr');
    const enInput = document.getElementById('cityNameEn');
    ...
    document.getElementById('createCityForm')?.addEventListener('submit', function() {
