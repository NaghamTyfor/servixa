...
@section('styles')
    ...
    <style>
        ...
        .city-card:hover .card-accent-bar {
            transform: scaleX(1);
        }
        ...
        .city-card:hover .city-icon-wrapper::before {
            transform: scale(1);
        }
        ...
        .city-card:hover .city-icon-wrapper svg {
            color: #fff;
        }
        ...
        body.dark .city-name-text {
            color: #e2e8f0;
        }

        .name-col-ar .city-name-text {
            direction: rtl;
            text-align: right;
        }

        .name-col-en .city-name-text {
            direction: ltr;
            text-align: left;
        }
...
<div class="layout-top-spacing">
        ...
        <div class="header-content">
            <div class="header-title-area">
                ...
                <div class="header-text">
                    ...
                    <p>{{ __('admin.cities_management') }}</p>
                </div>
            </div>
    ...
    <div class="cities-toolbar">
        <div class="toolbar-left">
            <div class="toolbar-search">
                ...
                <input type="text" id="searchInput" value="{{ request('search') }}" placeholder="{{ __('admin.search_cities') }}..." autocomplete="off">
    ...
    <div id="citiesContainer">
        @include('admin.cities.partials.grid')
    </div>
</div>

{{-- Delete Forms --}}
<form id="bulkDeleteForm" method="POST" action="{{ route('admin.cities.bulk-destroy') }}" style="display:none;">
    @csrf
...
<script>
    let checkboxes = document.querySelectorAll('.city-select-cb');
    ...
    function updateBulkBtn() {
        checkboxes = document.querySelectorAll('.city-select-cb');
        selectedIds = [...document.querySelectorAll('.city-select-cb:checked')].map(cb => cb.value);
        ...
        document.querySelectorAll('.city-card').forEach(card => {
            card.classList.toggle('selected', !!card.querySelector('.city-select-cb')?.checked);
        });
    ...
    function cardClickHandler(e) {
        if (e.target.closest('a,button,input,.action-icon-btn,.city-checkbox')) return;
    ...
    window.confirmDelete = function(btn, type = 'single') {
        ...
        if (type === 'single') {
            ...
            text = '{{ __('admin.delete_confirm_msg') }}: ' + btn.dataset.cityName;
        } else {
    ...
    function performSearch(val) {
        ...
        fetch(url.toString(), { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
            ...
            .then(html => {
                ...
                const nc = doc.getElementById('citiesContainer');
                if (nc) citiesContainer.innerHTML = nc.innerHTML;
                rebindEvents();
                highlightSearch();
    ...
    function highlightSearch() {
        ...
        document.querySelectorAll('.city-name-text').forEach(el => {
